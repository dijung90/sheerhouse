...
public class SettlementHistotyVO {
	...
	public SettlementHistotyVO(int set_seq, int host_seq, int apply_num, String title, int price, boolean status,
			String pay_date, Timestamp update_date, String statusKeyword) {
		super();
	...
	public String toString() {
		return "SettlementHistotyVO [set_seq=" + set_seq + ", host_seq=" + host_seq + ", apply_num=" + apply_num
				+ ", title=" + title + ", price=" + price + ", status=" + status + ", pay_date=" + pay_date
				+ ", update_date=" + update_date + ", statusKeyword=" + statusKeyword + "]";
	}

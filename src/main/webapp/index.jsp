  ...
  <body class="main">
      ...
      <section class="recommendPlaceContainer">
        ...
        <div>
          <div class="recommendImage image1">
            <a href="#"><img src="Images/place/place5.jpg" alt="place" /></a>
          </div>
          <div class="recommendImage image2">
            <a href="#"><img src="Images/place/place4.jpg" alt="place" /></a>
          </div>
          <div class="recommendImage image3">
            <a href="#"><img src="Images/place/place3.jpg" alt="place" /></a>
          </div>
          <div class="recommendImage image4">
            <a href="#"><img src="Images/place/place6.jpg" alt="place" /></a>
          </div>
        </div>
      </section>
      <section class="recommendActivityContainer">
        ...
        <div>
          <div class="recommendActivity activity1">
            <a href="#"
              ><img src="Images/activity/activity1.jpg" alt="place"
            /></a>
          </div>
          <div class="recommendActivity activity2">
            <a href="#"
              ><img src="Images/activity/activity2.jpg" alt="place"
            /></a>
          </div>
          <div class="recommendActivity activity3">
            <a href="#"
              ><img src="Images/activity/activity3.jpg" alt="place"
            /></a>
          </div>
          <div class="recommendActivity activity4">
            <a href="#"
              ><img src="Images/activity/activity4.jpg" alt="place"
            /></a>
          </div>
        </div>
      </section>
      ...
      <section class="footer"></section>
		...
		<div class="join-modal">
				<div class="join-modalContent">
					<div onclick="joinExitbtnClicked()" class="join-exitBtn"><img src="Images/icons/close.png" alt="cancel" /></div>
						...
						<div class="join facebookLogin">
								<a href="#"/>
									<div class="altercontent">
											<div class="alterJoinIcon"><img src="Images/icons/facebook.png"  alt="facebook login"/></div>
	...
	<div class="login-modal">
        ...
        <div class="login-exitBtn">
        	<img src="Images/icons/close.png" alt="cancel" />
        </div>
        ...
        <form class="loginForm">
          ...
          <div class="alterLoginContainer">
         	 ...
         	 <div class="login facebookLogin">
             	 <a href="#">
                    	...
                    	<div class="alterJoinIcon">
                    		<img src="Images/icons/facebook.png"  alt="facebook login"/>
                    	</div>
          ...
          <div class="login googleLogin">
           <a href="#">
                <div class="loginAltercontent">
                <div class="alterLoginIcon"><img src="Images/icons/google.png"  alt="google login"/></div>
                <span>구글로 로그인하기</span>
              </div>
            </a>
          </div>

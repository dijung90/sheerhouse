		...
		<div class="join-modal">
				<div class="join-modalContent">
					<div onclick="joinExitbtnClicked()" class="join-exitBtn">
						<img src="https://sheerhouse.s3.ap-northeast-2.amazonaws.com/Setting/Icons/close.png" alt="cancel" />
					</div>
					             	 ...
					             	 <a href="javascript:void(0)" >
					               		 <div class="loginAltercontent">
						                    	<div class="alterJoinIcon">
						                    		<img src="https://sheerhouse.s3.ap-northeast-2.amazonaws.com/Setting/Icons/facebook.png" alt="facebook login"/>
						                    	</div>
						            ...
						            <a href="javascript:void(0)">
							              <div class="altercontent">
							            		 <div class="alterLoginIcon">
							              				<img src="https://sheerhouse.s3.ap-northeast-2.amazonaws.com/Setting/Icons/kakao-talk.png"  alt="kakaotalk login"/>
							              		 </div>
